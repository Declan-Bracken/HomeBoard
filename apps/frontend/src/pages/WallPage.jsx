...
const styles = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .upload-zone:hover {
    border-color: rgba(255, 100, 40, 0.3);
    background: #1a1714;
  }
  ...
  const handleConfirm = async (finalHolds) => {
    try {
      ...
      if (Array.isArray(detail)) {
        ...
        setError(detail || 'Failed to confirm holds')
      }
    }
  }
      ...
      <div className="wall-root">
        ...
        <main className="wall-main">
          <div className="wall-header">
            ...
            {preview && (
              <button className="reupload-btn" onClick={() => setPreview(null)}>
                ↺ Re-upload
              </button>
            )}
          </div>
            ...
            <div className="canvas-section">
              <div className="canvas-header">
                ...
                <span className="canvas-meta">
                  {preview.image_width} × {preview.image_height}px
                </span>
              </div>
